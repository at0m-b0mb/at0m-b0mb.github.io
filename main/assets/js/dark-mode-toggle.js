...
function toggleDarkMode(newState) {
    ...
    if (newState == "on") {
        ...
        Array.from($(".navbar-toggler-icon")).forEach(function (x, y, z) {
            x.style = "background-color: #ffffff!important;";
        });
...
document.querySelector("a.dark-mode-toggle").addEventListener("click", function () {
